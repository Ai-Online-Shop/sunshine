    ...
    <section class="slide fade-4  scenic fullscreenSlider">
        <ul class="slider autoplay" data-slider-interval="4000" data-slider-id="fullscreen-slider">
            <li class="selected">
                        ...
                        <div class="wrap article">
                            ...
                            <div class="fix-12-12 center">
                                <div class="fix-11-12 text-white">
                                    ...
                                    <a class="button round white" href="{{route('gelbinger/impressionen')}}">Impressionen</a>
                                </div>
                            </div>
                ...
                <div class="background" style="background-image:url({{ asset('assets/img/gelbinger-slider-3.jpg') }})"></div>
            </li>
            <li>
                <div class="content">
                    <div class="container">
