                            ...
                            <div class="fix-12-12">
                                ...
                                <ul class="flex fixedSpaces later left">
                                    <li class="col-6-12 col-tablet-1-2 col-phone-1-1 ae-3">
                                        <img class="img-91 wide shadow" src="{{ asset('assets/img/sun-1.jpg') }}"
                                             alt="Video Thumbnail"/>
                                    </li>
                                    <li class="col-6-12 col-tablet-1-2 col-phone-1-1 ae-4">
                                        <div class="pad shadow center">
                                            ...
                                            <p class="micro">
                                                ...
                                                Ich habe mehr als 10 Jahre Erfahrung im Bereich Wellness, Spa und
                                                Gesundheit!</p>
                                            <p class="micro margin-top-1">
                                                In dieser Zeit war es mir möglich in den besten Spa Resorts in Thailand,
                                                in der
                                                Karibik und auf Mauritius zu arbeiten.</p>
                                            <p class="micro margin-top-1">
                                                Ausgebildet wurde ich im Bereich Ayurveda
                                                von dem weltbekannten Dr. Rajiv Marwah und Dr. Suchada. Des weiteren
                                                wurde ich in Reflexzonen Akupunkturmassage und Aromatherapie
                                                ausgebildet!</p>
                                            <p class="micro margin-top-1">
                            ...
                            <div class="fix-12-12">
                                ...
                                <ul class="flex fixedSpaces later left">
                                    <li class="col-3-12 col-tablet-1-2 col-phone-1-1">
                                        <a class="margin-bottom-2"><img class="img-91 wide"
                                                                        src="{{ asset('assets/img/slider-2.jpg') }}"
                            ...
                            <div class="fix-12-12">
                                ...
                                <ul class="flex fixedSpaces later left">
                                    <li class="col-6-12 col-tablet-1-2 col-phone-1-1">
                                        <img class="img-91 wide shadow" src="{{ asset('assets/img/spa1.jpg') }}"
                                             alt="Video Thumbnail"/>
                                    </li>
                                    <li class="col-6-12 col-tablet-1-2 col-phone-1-1">
                                        <div class="pad shadow center">
                                            ...
                                            <div class="gradient-line-3 gradient-left gradient-width-120 margin-bottom-2 margin-top-1"></div>
                                            <p class="micro">
                                                Sie wollten schon immer im Bereich Spa und Wellness arbeiten und
                                                gleichzeitig
                                                von einem tollen Team umgeben sein?</p>
                                            <p class="micro margin-top-1">
                                                Wir bieten ihnen exakt diese Möglichkeit.
                                                Zusätzlich bilden wir Sie in den verschiedensten Massagen professionell
                                                aus.</p>
                                            <a class=" small margin-top-3 blue button" href="{{route('kontakt')}}">Kontakt
                                                aufnehmen</a>
