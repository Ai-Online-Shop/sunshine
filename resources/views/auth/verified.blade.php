                    ...
                    <div class="fix-4-12 center">
                        <div class="pad shadow selected ae-1 fromTopRight">
                            <form role="form" method="POST" action="{{ route('login') }}">
                                ...
                                <h3 class="big ae-3">Erfolgreich!</h3>
                                <div class="gradient-line-3 gradient-left gradient-width-120 margin-top-1 ae-4"></div>
                                <p class="ae-5 light small">Dein Account ist erfolgreich verifiziert. Du kannst dich jetzt einloggen.</p>
                                <a href="{{route('login')}}" class="ae-5 ac-ln-button-2">Zum Login</a>
