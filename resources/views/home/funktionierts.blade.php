...
@section('content')
    ...
    <section class="slide  background-green">
        <div class="content">
            <div class="container">
                <div class="wrap">
                    ...
                    <div class="fix-12-12">
                        <h1 class="ae-2 fix-6-12 bold margin-bottom-5 text-white fromLeft">Das Sunshine-Wellness Angebot für unsere Gäste in Crailsheim:</h1>
                                ...
                                <ul class="slider" data-slider-id="31">
                                    ...
                                    <li>
                                        <div class="pad shadow center">
                                            ...
                                            @endif
                                            <div class="gradient-line-3 gradient-left gradient-width-120 margin-bottom-2 margin-top-1"></div>
                                            <h5 class="big">Laden Sie sich unsere aktuellen Preise und Angebote für Crailsheim einfach hier herunter.</h5>
                                            <a class="text-blue button green small rounded margin-top-3" href="/preise-crailsheim">Aktuelle Preisliste</a> <br />
        ...
        <!-- EXAMPLE: Background Youtube
        <div class="background youtube" style="background-image:url(https://img.youtube.com/vi/YXm_ThT1Qt4/maxresdefault.jpg);" class="player" data-property="{videoURL:'https://www.youtube.com/watch?v=pcW45ANesFg', containment:'self', startAt: 5, stopAt: 100, showControls:false, autoPlay:true, loop:true, mute:true, opacity:1, quality:'highres', stopMovieOnBlur:false, remember_last_time: true}"></div>
-->
    </section>


    <!-- EXAMPLE: Background Youtube -->
    <!-- 1) copy scripts and styles -->
    <script src="https://cdn.rawgit.com/pupunzi/jquery.mb.YTPlayer/9afc0466/dist/jquery.mb.YTPlayer.min.js"></script>
    <script>
        $(function(){
