                                    ...
                                    <form role="form" method="POST" action="{{ route('partner-sended') }}">
                                        ...
                                        <div class="col-lg-12 form-group ae-5">
                                            ...
                                            <select class="form-control select2" id="anfrage" name="anfrage" required>
                                                <option value="Ich möchte mehr wissen über Crailsheim">Anfrage</option>
                                                <option value="Termin vereinbaren Crailsheim" >Termin vereinbaren</option>
                                                <option value="Gutschein kaufen Crailsheim" >Gutschein kaufen</option>
                                                <option value="Informationen zu Wellness-Paketen Crailsheim" >Informationen zu Wellness-Paketen</option>
                                                <option value="Bewerbung als Mitarbeiter Crailsheim" >Bewerbung als Mitarbeiter</option>
                                                <option value="Fragen zu aktuellen Angeboten Crailsheim" >Fragen zu aktuellen Angeboten</option>
                                                <option value="Sonstige Anfrage Crailsheim" >Sonstige Anfrage</option>
                                            </select>
                                        </div>
