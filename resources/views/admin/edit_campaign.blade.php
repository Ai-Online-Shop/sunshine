        ...
        <div class="content">
            <div class="container">
                <div class="wrap">
                    ...
                    <h1 class="ae-1"><strong>Die Kampagne bearbeitenn</strong></h1>
                ...
                <div class="col-md-12">
                    <div class="name-67">
                        <div class="card-content">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group {{ $errors->has('min_amount')? 'has-error':'' }}">
                                        ...
                                        <input type="text" class="form-control" id="min_amount"
                                               value="{{ $campaign->min_amount }}" name="min_amount"
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group {{ $errors->has('max_amount')? 'has-error':'' }}">
                                        ...
                                        <input type="text" class="form-control" id="max_amount"
                                               value="{{ $campaign->max_amount }}" name="max_amount"
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group {{ $errors->has('amount_sparplan')? 'has-error':'' }}">
                                        ...
                                        <input type="text" class="form-control" id="amount_sparplan"
                                               value="{{ $campaign->amount_sparplan }}" name="amount_sparplan"
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group {{ $errors->has('laufzeit_sparplan')? 'has-error':'' }}">
                                        ...
                                        <input type="text" class="form-control" id="laufzeit_sparplan"
                                               value="{{ $campaign->laufzeit_sparplan }}" name="laufzeit_sparplan"
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group {{ $errors->has('zielsumme_sparplan')? 'has-error':'' }}">
                                        ...
                                        <input type="text" class="form-control" id="zielsumme_sparplan"
                                               value="{{ $campaign->zielsumme_sparplan }}" name="zielsumme_sparplan"
                                               placeholder="">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group {{ $errors->has('auszahlungssumme_sparplan')? 'has-error':'' }}">
                                        ...
                                        <input type="text" class="form-control" id="auszahlungssumme_sparplan"
                                               value="{{ $campaign->auszahlungssumme_sparplan }}" name="auszahlungssumme_sparplan"
                                               placeholder="">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group {{ $errors->has('zinsen_amount_sparplan')? 'has-error':'' }}">
                                        ...
                                        <input type="text" class="form-control" id="zinsen_amount_sparplan"
                                               value="{{ $campaign->zinsen_amount_sparplan }}" name="zinsen_amount_sparplan"
                                               placeholder="">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group {{ $errors->has('zinssatz_sparplan')? 'has-error':'' }}">
                                        ...
                                        <input type="text" class="form-control" id="zinssatz_sparplan"
                                               value="{{ $campaign->zinssatz_sparplan }}" name="zinssatz_sparplan"
                                               placeholder="">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="form-group {{ $errors->has('class')? 'has-error':'' }}">
                                        ...
                                        <input type="text" class="form-control" id="class"
                                               value="{{ $campaign->class }}" name="class"
                                               placeholder="">
                            ...
                            <button type="submit" class="ac-ln-button-2">Kampagne speichern</button>
                            <a href="{{ route('pending_campaigns') }}" class="ac-ln-button-2">Weiter</a>
