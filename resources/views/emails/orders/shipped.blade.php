...
<head>
    ...
    <link href='http://fonts.googleapis.com/css?family=Playfair+Display:400,700,400italic' rel='stylesheet'
          type='text/css'>
...
<table border="0" cellpadding="0" cellspacing="0"
       style="border-collaps:collaps; mso-table-lspace:0pt; mso-table-rspace:0pt;" width="100%" align="center">
    <tbody>
    ...
    <tr>
        <td width="100%">
            ...
            <table border="0" cellpadding="0" cellspacing="0" class="full"
                   style="margin: 0 auto; border-collaps:collaps; mso-table-lspace:0pt; mso-table-rspace:0pt;"
...
<table border="0" cellpadding="0" cellspacing="0"
    ...
    <tr>
        <td width="100%">
            ...
            <table border="0" cellpadding="0" cellspacing="0" class="fullw"
                   style="margin: 0 auto; border-collaps:collaps; mso-table-lspace:0pt; mso-table-rspace:0pt;"
            ...
            <table border="0" cellpadding="0" cellspacing="0" class="full"
                ...
                <tr>
                    <td width="600" class="full">
                        <table border="0" cellpadding="0" cellspacing="0"
                               style="border-collaps:collaps; mso-table-lspace:0pt; mso-table-rspace:0pt;" width="100%"
                               align="center">
                            <tbody>
                            <tr>
                                <td>
...
<table border="0" cellpadding="0" cellspacing="0"
    ...
    <tr>
        <td>
            ...
            <table border="0" cellpadding="0" cellspacing="0"
                   style="margin: 0 auto; border-collaps:collaps; mso-table-lspace:0pt; mso-table-rspace:0pt;"
                   width="600" class="full" align="center">
                <tbody>
                ...
                <!-- Start Title -->
                <tr>
                    <td class="mtitle" height="27"
                        style="text-align: center; font-size:27px;  font-family:'Playfair Display' , 'times new roman'; font-weight:normal ; line-height:27px; color: #274475;">
                        Vielen Dank!
                    </td>
                </tr>
                <!-- End Title -->
                ...
                <tr>
                    <td style="text-align: left; font-size:14px; font-family:'Droid Serif' , arial; font-weight:normal ; line-height:25px; color: #878787;">
                        ...
                        Diesen können Sie aus dem Anhang entnehmen und persönlich drucken. Falls Sie Ihren Gutschein
                        auch per Post bestellt haben, dann wird dieser gerade versandfertig gemacht und geht Ihnen
                        innerhalb 1-2 Tagen per Post zu. Sollten Sie ihren Gutschein doch per Post erhalten wollen, dann
                        schreiben Sie uns bitte unter amikahaag@gmail.com .
                        Wir hoffen Ihnen und Ihren/m Beschenkten eine Freude zu machen.
                        Als neuer online Kunde erhalten Sie persönlich auf eine Wellness Anwendung in unserem Spa in
                        Crailsheim oder Schwäbisch-Hall 5% Rabatt. Wir freuen uns auf Sie! (Rabatt ist unten mit
                        beigefügt)
                    </td>
                </tr>
                <!-- End Text -->
                ...
                <tr>
                    <td>
                        <table width="100%" cellspacing="0" cellpadding="0" border="0"
                               style="border-collaps:collaps; mso-table-lspace:0pt; mso-table-rspace:0pt;">
                            <tbody>
...
<table border="0" cellpadding="0" cellspacing="0"
    ...
    <tr>
        <td>
            <table border="0" cellpadding="0" cellspacing="0"
                   style="margin: 0 auto; border-collaps:collaps; mso-table-lspace:0pt; mso-table-rspace:0pt;"
                   class="full" width="600" align="center">
                <tbody>
                ...
                <tr>
                    <td>
                        <table bgcolor="f6f6f6" border="0" cellpadding="0" cellspacing="0"
                               style="border-collaps:collaps; mso-table-lspace:0pt; mso-table-rspace:0pt;" class="full"
                               width="600" align="center">
                            <tbody>
                                    ...
                                    <table border="0" cellpadding="0" cellspacing="0"
                                        ...
                                        <tr>
                                            <td style="border-bottom: 1px solid #dadada;">
                                                ...
                                                <table border="0" cellpadding="0" cellspacing="0"
                                                       style="border-collaps:collaps; mso-table-lspace:0pt; mso-table-rspace:0pt;"
                                                       class="packleft" width="439px" align="left">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td height="61"
                                                            style="text-align: left; font-size:17px; font-style:italic; font-family:'Playfair Display' , 'times new roman'; font-weight:normal ; color: #3d3d3d;">
                                                ...
                                                <table border="0" cellpadding="0" cellspacing="0"
                                                       style="border-collaps:collaps; mso-table-lspace:0pt; mso-table-rspace:0pt;"
                                                       class="packright" width="99px" align="right">
...
<table border="0" cellpadding="0" cellspacing="0"
    ...
    <tr>
        <td width="100%">
            ...
            <table bgcolor="ededed" border="0" cellpadding="0" cellspacing="0" class="fullw"
                   style="margin: 0 auto; border-collaps:collaps; mso-table-lspace:0pt; mso-table-rspace:0pt;"
                   width="820" align="center">
                <tbody>
                <tr>
                    ...
                    <td>
                        ...
                        <table width="600" cellspacing="0" cellpadding="0" border="0" align="center" class="full"
                               style="border-collaps:collaps; mso-table-lspace:0pt; mso-table-rspace:0pt;">
