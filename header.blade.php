...
<head>
    ...
    <title> @yield('title')ImmoFound @show </title>
...
<body class="slides scroll slow smoothScroll animateOnScroll">
<!-- SVG Library -->
<svg xmlns="http://www.w3.org/2000/svg" style="display:none">
    <symbol id="logo" viewBox="0 0 150 79" style="enable-background:new 0 0 150 79;" xml:space="preserve">
    <g>
        <polygon points="134.8,59.2 121.3,48.2 121.3,72.7 94.3,72.7 94.3,25.7 80.8,15.2 80.8,72.7 69.7,72.7 69.7,15.2 56.2,25.7
		56.2,72.7 29.3,72.7 29.3,48.2 15.8,59.2 15.8,72.7 2.3,72.7 2.3,78 21.1,78 21.1,61.8 24,59.5 24,78 61.6,78 61.6,28.2 64.4,26
		64.4,78 86.2,78 86.2,26 88.9,28.2 88.9,78 126.6,78 126.6,59.5 129.4,61.8 129.4,78 148.2,78 148.2,72.7 134.8,72.7 	"/>
        <polygon points="107.8,34 107.8,64.5 102.4,64.5 102.4,22.3 75.3,0.1 48.1,22.3 48.1,64.5 42.8,64.5 42.8,34 37.4,31.1 7.7,55.3
		7.7,69.9 13.1,69.9 13.1,57.9 32,42.4 32,69.9 53.5,69.9 53.5,24.8 72.6,9.2 72.6,69.9 78,69.9 78,9.2 97,24.8 97,69.9 118.5,69.9
		118.5,42.4 137.5,57.9 137.5,69.9 142.9,69.9 142.9,55.3 113.1,31.1"/>
    </g>
  </symbol>
...
<nav class="panel top fixed">
    <div class="sections desktop">
        ...
        <div class="left"><a href="https://www.immofound.eu">
                <svg style="width:107px;height:31px">
                    <use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#logo"></use>
                </svg>
            </a></div>
        <div class="center">
            <ul class="menu small sourceSans">
                @if(Auth::guest())
                <li><a href="{{ route('funktionierts') }}">So funktioniert‘s</a></li>
                <li tabindex="1" class="dropdownTrigger" data-dropdown-hover="true" data-dropdown-id="111">Über uns
                    <svg class="dropdown-icon">
                        <use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#drop-down"></use>
                    </svg>
                </li>
                <li tabindex="1" class="dropdownTrigger" data-dropdown-hover="true" data-dropdown-id="333">Investieren
                    <svg class="dropdown-icon">
                        <use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#drop-down"></use>
                    </svg>
                </li>
                <li tabindex="2" class="dropdownTrigger" data-dropdown-id="222">Magazin
                    <svg class="dropdown-icon">
                        <use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#drop-down"></use>
                    </svg>
                </li>
        ...
        @if(Auth::guest())
            <div class="right"><a href="{{ route('welcome') }}" class="button rounded stroke blue  small margin-right-2">Zur App</a></div></div>

        @else
    <div class="right"><span class="button actionButton dropdownTrigger" data-dropdown-id="social"><i class="material-icons">favorite_border</i></span> <span class="button actionButton margin-right-2 sidebarTrigger" data-sidebar-id="1"><i class="material-icons">explore</i></span></div>
    ...
    <div class="sections compact">
        @if(Auth::guest())
            <div class="left"><a href="{{ route('welcome') }}" class="button rounded small stroke blue">App</a></div>
        @else
            <div class="left"><span class="button actionButton dropdownTrigger" data-dropdown-id="social"><i class="material-icons">favorite_border</i></span></div>
        @endif
        <div class="center"><h2 class="float-right2">ImmoFound</h2></div>
        <div class="right"><span class="button actionButton sidebarTrigger" data-sidebar-id="1"><i class="material-icons">explore</i></span></div>
    </div>
</nav>

<!-- Menu dropdown 111-->
<div class="dropdown top left center customDropdown" data-dropdown-id="111">
    <ul>
        <li><a href="{{route('idee')}}">Idee</a></li>
        <li><a href="{{route('gründer')}}">Gründer</a></li>
        <li><a href="{{route('partner')}}">Partner</a></li>
        <li><a href="{{route('kunden')}}">Kunden</a></li>
    </ul>
</div>

<!-- Menu dropdown 222-->
<div class="dropdown top left center customDropdown" data-dropdown-id="222">
    <ul>
        <li><a href="{{route('blog')}}">Blog</a></li>
        <li><a href="{{route('wiki')}}">Wiki</a></li>
        <li><a href="{{route('magazin')}}">Magazin</a></li>
        <li><a href="{{route('ebook')}}">Ebook</a></li>
    </ul>
</div>

<!-- Menu dropdown 222-->
<div class="dropdown top left center customDropdown" data-dropdown-id="333">
    <ul>
        <li><a href="{{route('direkt-investment')}}">Direkt-Invest</a></li>
        <li><a href="{{route('sparpläne')}}">Sparpläne</a></li>
        <li><a href="{{route('portfolio')}}">Portfolio</a></li>
        <li><a href="{{route('hilfe-center')}}">Hilfe-Center</a></li>
    </ul>
</div>

<!-- Sidebar Trigger 1-->
<nav class="sidebar animated fromLeft" data-sidebar-id="1">
    <div class="close ae-1 text-white"><i class="material-icons">arrow_back</i></div>
    <div class="window fromBlur">
        <div class="overlay ae-3">@if(Auth::guest())<img class="overlay" src="{{ asset('assets/img/immo-profil-default.jpg') }}" alt="" />@else <img class="overlay" src="{{ $user->get_gravatar(100) }}" alt="" /> @endif</div>
        <div class="box header">@if(Auth::guest())<img class="block2" src="{{ asset('assets/img/immo-profil-default.jpg') }}" alt="" />@else <img class="block2" src="{{ $user->get_gravatar(100) }}" alt="" /> @endif
            <h3>@if(Auth::guest())ImmoFound @else {{ $user->vorname }} {{ $user->nachname }} @endif</h3>
        </div>
    </div>
    <h2 class="margin-2 text-black opacity-3"><strong>Exklusiv</strong></h2>
    <div class="margin-left-4">
        <div class="owl-carousel owl-theme">
            <div class="item"><img class="background-owl" src="assets/img/ich.jpg"/>
                <h3 class="text-owl">Blog 1</h3>
            </div>
            <div class="item"><img class="background-owl" src="assets/img/ich.jpg"/>
                <h3 class="text-owl">Blog 2</h3>
            </div>
    ...
    @if(Auth::guest())
        <!--User ist ausgeloggt-->
            <li><a href="{{ route('funktionierts') }}"><i class="margin-left-1 material-icons margin-right-1">beenhere</i>So funktionierts</a></li>
            <li><a class="submenu-dropdown"><i class="margin-left-1 material-icons margin-right-1">flag</i>Über uns<i class="material-icons margin-right-1">keyboard_arrow_down</i></a>
                <ul class="mainMenu small submenu-elements" style="display: none">
                    <li><a href="{{route('idee')}}">- Idee</a></li>
                    <li><a href="{{route('gründer')}}">- Gründer</a></li>
                    <li><a href="{{route('partner')}}">- Partner</a></li>
                    <li><a href="{{route('kunden')}}">- Kunden</a></li>
            ...
            <li><a class="submenu-dropdown3"><i class="margin-left-1 material-icons margin-right-1">euro_symbol</i>Investieren<i class="material-icons margin-right-1">keyboard_arrow_down</i></a>
                <ul class="mainMenu small submenu-elements3" style="display: none">
                    <li><a href="{{route('direkt-investment')}}">- Direkt-Invest</a></li>
                    <li><a href="{{route('sparpläne')}}">- Sparpläne</a></li>
                    <li><a href="{{route('portfolio')}}">- Portfolio</a></li>
                    <li><a href="{{route('hilfe-center')}}">- Hilfe-Center</a></li>
            ...
            <li><a class="submenu-dropdown2"><i class="margin-left-1 material-icons margin-right-1">book</i>Magazin<i class="material-icons margin-right-1">keyboard_arrow_down</i></a>
    ...
    @else
        <!--User ist eingeloggt-->
            <li><a href="{{ route('browse_categories') }}"><i class="margin-left-1 material-icons margin-right-1">euro_symbol</i>Investieren</a></li>
            <li><a href="{{ route('dashboard') }}"><i class="margin-left-1 material-icons margin-right-1">assessment</i>Statistik</a></li>
            <li><a href="{{ route('general_settings') }}"><i class="margin-left-1 material-icons margin-right-1">business_center</i>Verträge</a></li>
            <li><a class="submenu-dropdown4"><i class="margin-left-1 material-icons margin-right-1">face</i>Profil<i class="material-icons margin-right-1">keyboard_arrow_down</i></a>
                <ul class="mainMenu small submenu-elements4" style="display: none">
                    <li><a href="{{route('profile')}}">- Profil anzeigen</a></li>
                    <li><a href="{{route('profile_edit')}}">- Profil bearbeiten</a></li>
                    <li><a href="{{route('change_password')}}">- Passwort ändern</a></li>
                </ul>
            </li>
            <li><a href="{{ route('logout') }}" onclick="event.preventDefault();
                                document.getElementById('logout-form').submit();">
                    <i class="margin-left-1 material-icons margin-right-1">power_settings_new</i>Logout
                </a>
    ...
    <img class="bottom margin-top-4" src="{{ asset('assets/svg/rounded.svg') }}"/> </nav>

<!-- Share Window -->
<div class="dropdown share top right" data-dropdown-id="social" data-text="Schau dir das mal an!" data-url="https://immofound.eu" data-pinterest-image="(/assets/img/immo-profil-default.jpg)">
