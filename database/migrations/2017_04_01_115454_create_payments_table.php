...
class CreatePaymentsTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('payments', function (Blueprint $table) {
            ...
            $table->text('widmung')->nullable();
            $table->string('upsale')->nullable();
            $table->string('versandart')->nullable();
            ...
            $table->enum('gutscheinstatus', ['initial','pending','success','failed','declined','dispute'])->default('initial')->nullable();
            ...
            $table->string('created_at_two')->nullable();
